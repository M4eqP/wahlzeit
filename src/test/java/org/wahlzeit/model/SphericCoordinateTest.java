...
public class SphericCoordinateTest {
    ...
    public void testEquals() {
        SphericCoordinate c1a = Coordinate.getSphericCoordinate(0, 0, 0);
        SphericCoordinate c1b = Coordinate.getSphericCoordinate(0, 0, 0);
        ...
        SphericCoordinate c2 = Coordinate.getSphericCoordinate(1, 1, 1);
    ...
    public void testGetSphericDistance() {
        SphericCoordinate c1 = Coordinate.getSphericCoordinate(0, 0, 0);
        SphericCoordinate c2 = Coordinate.getSphericCoordinate(1, 1, 1);
        SphericCoordinate c3 = Coordinate.getSphericCoordinate(1, 2, 3);
    ...
    public void testGetters() {
        SphericCoordinate c1 = Coordinate.getSphericCoordinate(2, 3, 30);
    ...
    public void testConversionFromAndToCartesianCoordinate() {
        SphericCoordinate c1 = Coordinate.getSphericCoordinate(-3, 2 ,30);
    ...
    private void assertConstructorThrowsInvalidArgumentException(double phi, double theta, double radius) {
        try {
            Coordinate.getSphericCoordinate(phi, theta, radius);
    ...
    public void testConstructFromValuesOutsideRange() {
        ...
        Coordinate.getSphericCoordinate(-Math.PI, 0, 30);
        Coordinate.getSphericCoordinate(Math.PI - 0.0001, Math.PI, 30);
        Coordinate.getSphericCoordinate(Math.PI - 0.0001, Math.PI, 0);
